            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- No Labels Form -->
                        <form class="row g-3" action="<?= site_url('/services/update/'). $id?>" method="post">
                            <div class="col-md-12">
                                <input type="text" class="form-control" name="title" value="<?=$title?>" placeholder="Service Title">
                            </div>
                            <div class="col-md-12">
                                <textarea name="description" id="" class="tinymce-editor"
                                    placeholder="Service Description"><?=$description?></textarea>
                            </div>
