                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- No Labels Form -->
                            <form class="row g-3" action="<?php echo site_url('photos/update/'. $id );?>" method="post" enctype="multipart/form-data">
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="name" placeholder="Name" value="<?=$name?>">
                                </div>
                                <div class="col-md-12">
                                    <input type="file" class="form-control" name="photo" placeholder="Photo" value="<?=$photo?>">
                                </div>
