                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?= validation_list_errors() ?>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="name" value="<?=$product?>" placeholder="Product Name">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" value="<?=$sku?>" name="sku" placeholder="SKU">
                                </div>
                                <div class="col-md-6">
                                    <input type="file" class="form-control" name="photo" value="<?=$photo?>" placeholder="Product Photo">
                                </div>
