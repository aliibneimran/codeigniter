  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="service" class="nav-content collapse" data-bs-parent="#sidebar-nav">
        ...
        <li><a href="<?= base_url('/editor/services/add-service') ?>"><i class="bi bi-circle"></i><span>Add vService</span></a></li>
      </ul>
    </li>
    <!--Property-->
    <li class="nav-item">
      ...
      <ul id="property" class="nav-content collapse" data-bs-parent="#sidebar-nav">
        ...
        <li><a href="<?= base_url('/editor/properties/add-property') ?>"><i class="bi bi-circle"></i><span>Add Property</span></a></li>
      </ul>
    </li>
    <!--Category-->
    <li class="nav-item">
      ...
      <ul id="category" class="nav-content collapse" data-bs-parent="#sidebar-nav">
        ...
        <li><a href="<?= base_url('/editor/categories/add-category') ?>"><i class="bi bi-circle"></i><span>Add Category</span></a></li>
      </ul>
    </li>
